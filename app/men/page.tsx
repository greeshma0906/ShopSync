  ...
  return (
    <div className="min-h-screen">
      ...
      <main className="container mx-auto px-4 py-8">
        <div className="mb-8">
          <h1 className="text-3xl font-bold mb-4 text-balance">Men's Fashion</h1>
          <div className="flex flex-wrap gap-4 mb-6">
            <Link href="/men/topwear">
              <Button variant="outline">Topwear</Button>
            </Link>
            <Link href="/men/bottomwear">
              <Button variant="outline">Bottomwear</Button>
            </Link>
