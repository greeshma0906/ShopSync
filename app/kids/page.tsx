...
export default function KidsPage() {
  ...
  const { filters, setFilters, sortBy, setSortBy, filteredProducts, filterOptions, totalProducts, filteredCount } =
    useProductFilters(kidsProducts)
  ...
  return (
    <div className="min-h-screen">
      ...
      <main className="container mx-auto px-4 py-8">
        <div className="mb-8">
          <h1 className="text-3xl font-bold mb-4 text-balance">Kids Fashion</h1>
          <div className="flex flex-wrap gap-4 mb-6">
            <Link href="/kids/boys">
              <Button variant="outline">Boys</Button>
            </Link>
            <Link href="/kids/girls">
              <Button variant="outline">Girls</Button>
            </Link>
            <Link href="/kids/infants">
              <Button variant="outline">Infants</Button>
            </Link>
          </div>
        </div>
