...
export class GoogleCalendarService {
  ...
  analyzeEvent(event: CalendarEvent): EventAnalysis {
    ...
    const formalScore = formalKeywords.filter((keyword) =>
      text.includes(keyword)
    ).length;
    ...
    const partyScore = partyKeywords.filter((keyword) =>
      text.includes(keyword)
    ).length;
    ...
    const festivalScore = festivalKeywords.filter((keyword) =>
      text.includes(keyword)
    ).length;
    ...
    const sportsScore = sportsKeywords.filter((keyword) =>
      text.includes(keyword)
    ).length;
    ...
    const scores = [
      ...
      },
      {
        type: "party" as const,
        score: partyScore,
        categories: ["men-party", "women-party", "accessories-party"],
      },
      {
      ...
      },
      {
        ...
        score: sportsScore,
        categories: ["men-sports", "women-sports", "footwear-sports"],
      },
      {
        type: "travel" as const,
        score: travelScore,
        categories: ["men-casual", "women-casual", "accessories-travel"],
      },
    ];
